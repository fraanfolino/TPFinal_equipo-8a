                            ...
                            <ItemTemplate>
                                <div class="card mb-3">
                                    <div class="row g-0">
                                       ...
                                       <div class="col-md-4">
                            <div id='<%# "carouselProducto_" + Container.ItemIndex %>' class="carousel slide" data-bs-ride="carousel">
                                ...
                                <button class="carousel-control-prev" type="button" data-bs-target='<%# "#carouselProducto_" + Container.ItemIndex %>' data-bs-slide="prev">
                                    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                    <span class="visually-hidden">Anterior</span>
                                </button>

        
                                <button class="carousel-control-next" type="button" data-bs-target='<%# "#carouselProducto_" + Container.ItemIndex %>' data-bs-slide="next">
